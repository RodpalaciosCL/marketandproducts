(function () {
  const STRINGS = {
    en: {
      ...
      'prod-airontech-name': 'A.I.rontech',
      'prod-airontech-desc': 'Computer Vision & AI for Multi Industries',
    ...
    es: {
      ...
      'prod-airontech-name': 'A.I.rontech',
      'prod-airontech-desc': 'Visión computacional e IA para múltiples industrias',
